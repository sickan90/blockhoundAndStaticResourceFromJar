# BlockHound and static resources from Jar
This repo will reproduce the error of using blockhound and trying to get a static resource from a Jar file

## Reproduce
1) Run with 
``./mvnw spring-boot:run``
   
2) Navigate to http://localhost:8080/webjars/swagger-ui/3.49.0/index.html

## The error
The error that you will get is
````text
2021-07-06 10:27:19.539 ERROR 13612 --- [ctor-http-nio-2] a.w.r.e.AbstractErrorWebExceptionHandler : [eaee4b8f-1]  500 Server Error for HTTP GET "/webjars/swagger-ui/3.49.0/index.html"
...
Error has been observed at the following site(s):
        |_ checkpoint ? HTTP GET "/webjars/swagger-ui/3.49.0/index.html" [ExceptionHandlingWebHandler]
Stack trace:
                at java.base/java.io.RandomAccessFile.readBytes(RandomAccessFile.java) ~[na:na]
